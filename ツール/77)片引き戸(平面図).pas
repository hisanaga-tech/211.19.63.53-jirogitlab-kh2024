...
BEGIN
	...
	BeginDialog(1,1,sh-cMarginX div 2,sv-cMarginX div 2,sh+cMarginY div 2,sv+cMarginY div 2);
          ...
          AddField('       - KITCHEN HOUSE -',40,1,10,1,200,21);
			AddField('  ∮ 4)片引き戸  (平面図)',41,1,10,20,200,40);
...
BeginGroup;
closepoly;
poly(x,y,x,y+d,x+3*a+2*w,y+d,x+3*a+2*w,y+d/2,x+2*a+w,y+d/2,x+2*a+w,y); 
     

     pensize(12);
  rect(x,y+d,x+a,y);
 rect(x+a+w,y+d/2,x+2*a+w,y);
rect(x+2*a+2*w,y+d,x+3*a+2*w,y+d/2);
